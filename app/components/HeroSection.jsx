  ...
  return (
    ...
    />
               ...
               <div className='text-[#ADB7BE] text-base  sm:text-lg  mb-6  lg:text-xl'>
                A passionate web developer with strong problem-solving skills. Specializing in creating seamless digital experiences using front-end and back-end technologies to deliver high-quality solutions that exceed expectations.
               </div>
            <div> 
            <Link
              href="/#contact"
        ...
        <motion.div initial={{opacity: 0,scale: 0.5}} animate={{opacity: 1,scale: 1}} transition={{ duration: 0.5}}  className='col-span-4 place-self-center mt-4 lg:mt-0'>
          <div className='rounded-full bg-[#181818] w-[250px] h-[250px] lg:w-[400px] lg:h-[400px]'>
            <Image
             ...
             alt="hero-image"
             className='rounded-full bg-[#181818] w-500 h-400'
             width={300}
             height={300}
            />
          </div>
